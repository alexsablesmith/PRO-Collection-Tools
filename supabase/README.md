...
| `20260917000011_drop_auth_profile_triggers.sql` | Drops the `auth.users` triggers that auto-created active profiles from sign-up metadata (privilege escalation; broke invites) | Security; invite flow |
